...
Builder.prototype.pushValue = function(name, value) {
...
Builder.prototype.getWrappedValues = function() {
	var self = this;
	var values = {};
	_(this._values).each(function(value, name) {
		values[self.wrapPlaceholder(name)] = value;
	});
	return values;
};
