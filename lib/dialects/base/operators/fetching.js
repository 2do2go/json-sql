...
module.exports = function(dialect) {
	dialect.operators.fetching.add('$field', {
		fn: function(value) {
			return dialect.buildBlock('field', {field: value, type: 'name'});
		}
	});
	...
	dialect.operators.fetching.add('$func', {
		fn: function(value) {
			return dialect.buildBlock('field', {field: value, type: 'func'});
		}
	});

	dialect.operators.fetching.add('$expression', {
		fn: function(value) {
			return dialect.buildBlock('field', {field: value, type: 'expression'});
		}
	});
