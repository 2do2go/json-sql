...
module.exports = function(dialect) {
	...
	dialect.blocks.add('isEmptyArray', function(params) {
		var isEmptyArray = params.isEmptyArray;

		if (!_.has(isEmptyArray, 'type')) {
			throw new Error('`$isEmptyArray.type` property is required');
		}

		var result = 'array[]::'+isEmptyArray.type+'[]'
